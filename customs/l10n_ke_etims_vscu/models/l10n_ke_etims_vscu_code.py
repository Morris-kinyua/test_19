...
class L10nKeVSCUCode(models.Model):
    ...
    def _cron_get_codes_from_device(self):
        ...
        last_request_date = self.env['ir.config_parameter'].get_param('l10n_ke_vscu.last_code_request_date', '20180101000000')
        ...
        self.env['ir.config_parameter'].sudo().set_param('l10n_ke_vscu.last_code_request_date', format_etims_datetime(fields.Datetime.now()))
